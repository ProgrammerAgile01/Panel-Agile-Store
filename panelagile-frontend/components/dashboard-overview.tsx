    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="glass-morphism border-l-4 border-l-accent animate-pulse-glow bg-gradient-to-br from-card to-accent/5">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              <strong className="text-foreground">23 customers</strong> will
              have their subscriptions expire this week. Send them renewal
              reminders to reduce churn.
            </p>
        ...
        <Card className="glass-morphism border-l-4 border-l-primary bg-gradient-to-br from-card to-primary/5 glow-primary">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              ...
              has 85% conversion rate. Consider promoting it to increase monthly
              revenue by ~$12,000.
            </p>
            {/* ACTIONS: stack on mobile, row on >=sm */}
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full">

...
//         const { packages, durations, pricelist } = await loadPricelistBundle(
//           code
//         );
...
//             (i) => i.duration_id === duration.id && i.package_id === pkg.id
//           );
//           if (!exists)
//             newItems.push({
//               duration_id: duration.id,
...
//             <p className="text-sm/5 text-slate-300">
...
//                         <span>
//                           {selectedProduct?.id === product.id
//                             ? selectedProduct.packages.length
//                             : "—"}
//                         </span>
//                       </div>
//                       <div className="flex items-center gap-1">
...
//                         <span>
//                           {selectedProduct?.id === product.id
//                             ? selectedProduct.durations.length
//                             : "—"}
//                         </span>
//                       </div>
//                     </div>
...
//                   Choose a product from the left panel to start managing its
//                   pricing matrix.
//                 </p>
//               </div>
//             </div>
...
//                     Packages or Durations not found
//                   </h3>
//                   <p className="text-muted-foreground mb-6">
//                     This product needs packages and durations before you can set
//                     up pricing.
//                   </p>
...
//                       Pricelist for {selectedProduct?.name || "Unknown Product"}
//                     </h1>
//                     <p className="text-muted-foreground">
//                       Set prices per Package & Duration
//                     </p>
//                   </div>
//                   {hasUnsavedChanges && (
...
//                           display: "grid",
//                           gridTemplateColumns:
//                             "minmax(220px, 0.9fr) repeat(auto-fit, minmax(180px, 1fr))",
...
//                           <th
//                             key={pkg.id}
//                             className="text-center p-3 font-medium border-r border-border"
//                           >
...
//           .price-grid {
//             grid-template-columns: minmax(220px, 0.9fr) repeat(
//                 auto-fit,
//                 minmax(200px, 1fr)
//               );
//           }
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        const dto: PricelistDTO = pricelist;
        setCurrency(dto.currency || "IDR");
        setTaxMode((dto.tax_mode as any) || "inclusive");
        setPricelistData({
          currency: dto.currency || "IDR",
          tax_mode: (dto.tax_mode as any) || "inclusive",
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                  ...
                  <div className="w-full md:w-auto overflow-x-auto">
                    <div className="inline-flex items-center gap-2 min-w-max">
                      <Button
                        onClick={handleSave}
                        className="shrink-0 whitespace-nowrap bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700"
                      >
                        <Save className="h-4 w-4 mr-2" />
                        Save
                      </Button>
                ...
                <div className="relative overflow-auto">
                  <table className="w-full border-collapse">
                    <thead className="sticky top-0 z-10 bg-background">
                      <tr>
                        <th className="sticky left-0 bg-background text-left p-3 border-b">
                          Duration
                        </th>
                        {selectedProduct.packages.map((pkg) => (
                          <th key={pkg.id} className="p-3 text-center border-b">
                            <div className="flex flex-col items-center gap-2">
                    ...
                    <tbody>
                      {filteredDurations.map((duration) => (
                        <tr key={duration.id} className="hover:bg-muted/30">
